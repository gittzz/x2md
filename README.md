...
- 当前最新版本：[`v2.0.2`](https://github.com/izscc/x2md/releases/tag/v2.0.2)
- 下载对应平台包：
  - Mac: [`X2MD_Mac.zip`](https://github.com/izscc/x2md/releases/download/v2.0.2/X2MD_Mac.zip)
  - Windows: [`X2MD_Windows.zip`](https://github.com/izscc/x2md/releases/download/v2.0.2/X2MD_Windows.zip)
  - 扩展: [`X2MD_Extension.zip`](https://github.com/izscc/x2md/releases/download/v2.0.2/X2MD_Extension.zip)
